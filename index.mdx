...
<CardGroup cols={2}>
  ...
  <Card title="ACP Protocol" icon="network-wired">
    Agent Client Protocol support for integration with Zed and other editors
  </Card>
</CardGroup>
...
<AccordionGroup>
  ...
  <Accordion title="Editor Integration">
    Connect Terramind to Zed or other editors via the Agent Client Protocol for seamless in-editor AI assistance.
  </Accordion>
</AccordionGroup>
